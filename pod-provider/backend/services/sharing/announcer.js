...
// If using RedPanda + OpenSearch, use the version of the announcer configured to use RedPanda + OpenSearch. Otherwise, use the original.
// This has been configured with two separate announcer configurations in attempt to avoid an unnecessary if statements each time an activity is emitted.
if (CONFIG.USE_RPOS) {
  module.exports = {
    name: 'announcer',
    ...
    activities: {
      announce: {
        ...
        async onEmit(ctx, activity, emitterUri) {
          ...
          // TODO add handling here for actors on instances of different protocols (e.g. ATProto, Mastodon)
          ...
          if (activity.to && arrayOf(activity.to).includes("https://www.w3.org/ns/activitystreams#Public")) {
            try {
...
// Original implementation prior to addition of RP + OS
else {
  module.exports = {
    name: 'announcer',
    mixins: [ActivitiesHandlerMixin],
